          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                ...
                <FormColor :colors="product.colors" />
      ...
      <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <p>
            ...
            а также сохраняются на смартфоне. При этом на мобильное устройство можно
            установить как фирменное приложение, так и различные приложения сторонних разработчиков.
...
export default {
  name: 'ProductPage',
  components: { FormCounter, FormColor },
  data() {
    return {
      productAmount: 1,
      productData: null,
